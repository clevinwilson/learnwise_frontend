    ...
    <div>
      <div className="text-gray-500 min-h-screen ">
        ...
        <div className="container text-gray-500 mx-auto max-w-6xl ">
          ...
          <h1 className="text-2xl font-bold  px-6 md:px-0">Account Settings</h1>
            ...
            <div className="w-full shadow-lg bg-white rounded-lg mx-auto mt-8 flex overflow-hidden rounded-b-none">
              ...
              <div className="md:w-2/3 w-full">
                ...
                <div className="py-8 px-16">
                  ...
                  <input className="mt-2 border-2 border-gray-200 px-3 py-2 block w-full rounded-lg text-base text-gray-900 focus:outline-none focus:border-indigo-500" type="text" name="newPassword" defaultValue />
                </div>
                <div className="py-8 px-16">
                  <label htmlFor="email" className="text-sm text-gray-600">Confirm Password</label>
                  <input className="mt-2 border-2 border-gray-200 px-3 py-2 block w-full rounded-lg text-base text-gray-900 focus:outline-none focus:border-indigo-500" type="text" name="confirmPassword" defaultValue />
                </div>
