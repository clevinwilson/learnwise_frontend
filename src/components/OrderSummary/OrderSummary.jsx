            ...
            <div className='w-full lg:w-8/12'>
              <div className="flex justify-center sm:mx-10 m-3">
                <a href="#" className="flex w-full flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                  <img className="object-cover m-8 lg:m-4  ml-4 rounded h-40 md:96 md:h-auto w-100 md:w-48" src={`http://localhost:3000/${courseDetails.image.path}`} alt />
                ...
                <div className='mt-8'>
                  <form>
                    ...
                    <div className="mb-6">
                      ...
                      <input onChange={() => { handleChange(event) }} value={formik.values.pincode} type="text" name='pincode' id="pincode" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder='Pin Code' required />
              ...
              <div className='flex lg:block justify-center mt-10 lg:mt-0 m-3 ' >
                <div className=" p-6 w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                  ...
                  <div className='flex justify-between mt-5'>
                    ...
                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">₹ {courseDetails.price}</p>
                  </div>
