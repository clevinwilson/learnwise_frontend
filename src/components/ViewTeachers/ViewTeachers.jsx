                ...
                <nav className="flex items-center justify-between p-3 mt-4" aria-label="Table navigation">
                    ...
                    <ul className="inline-flex items-center -space-x-px">
                        {pagination?.previous ?
                            <>
                                <li>
                                    <a onClick={() => { getTeachersDetails(pagination?.current - 1) }} className="block px-3 py-2 ml-0 leading-tight text-gray-500 bg-white border border-gray-300 rounded-l-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                                        <span className="sr-only">Previous</span>
                                        <BsChevronLeft size={19} />
                                    </a>
                                </li>
                                <li>
                                    <a onClick={() => { getTeachersDetails(pagination?.current - 1) }} className="px-3 py-2 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">{pagination?.current - 1}</a>
                                </li>
                            </>
                            :
                            <li>
                        ...
                        {pagination?.next ?
                            <>
                                ...
                                <li >
                                    <a onClick={() => { getTeachersDetails(pagination?.current + 1) }} className="block px-3 py-2 leading-tight text-gray-500 bg-white border border-gray-300 rounded-r-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
