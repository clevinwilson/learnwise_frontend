...
function SyllabusDropdown({ course, index, toggleDropdown }) {
    return (
        <div
        ...
        >
            <div className={"syllabus-title p-4 " + (course.open ? "lesson-open-bg" : "")} >
            ...
            </div>
            {
                course.lessons.map((lesson,index) => {
                    return (
                        <div key={index} className={"lessons-title " + (course.open ? "p-4" : "")}>
