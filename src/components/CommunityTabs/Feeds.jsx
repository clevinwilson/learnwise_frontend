...
function Feeds({ togglePostModal }) {
  return (
      <div className='grid grid-cols gap-4'>

         <div className='flex justify-center'>
              <div onClick={togglePostModal} className='w-full max-w-3xl flex p-5 bg-white shadow rounded-lg cursor-pointer'>
                  <img class="w-10 h-10 rounded-full mr-5" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="Default avatar" />
          ...
          <div className='w-full flex justify-center'>
              <div className="px-5 py-4 bg-white dark:bg-gray-800 shadow rounded-lg max-w-3xl">
                  ...
                  <p className="text-gray-800 dark:text-gray-100 leading-snug md:leading-normal">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
                  <div className='mt-5'>
                      <img
