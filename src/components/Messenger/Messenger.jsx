                        ...
                        <div className="search-box p-4 flex-none">
                            <form onsubmit>
                                <div className="relative">
                                    <label>
                                        <input className="rounded-full py-2 pr-6 pl-10 w-full border border-gray-800 focus:border-gray-700 bg-gray-800 focus:bg-gray-900 focus:outline-none text-gray-200 focus:shadow-md transition duration-300 ease-in" type="text" defaultValue placeholder="Search Messenger" />
                        ...
                        <section className="flex flex-col flex-auto border-l border-gray-800">
                            ...
                            <div className="chat-footer flex-none">
                                <div className="flex flex-row items-center p-4">
                                    ...
                                    <button type="button" className="flex flex-shrink-0 focus:outline-none mx-2 h-9 w-9 bg-blue-500 text-white  justify-center items-center rounded-full">
                                        <IoSend size={23}
