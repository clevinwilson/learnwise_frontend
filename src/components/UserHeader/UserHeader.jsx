        ...
        <div className='shadow-md'>
            <nav className="relative px-4 py-4 flex justify-between items-center bg-white">
                ...
                <div className="  items-center md:order-2 cursor-pointer">
                    {user.firstName ? <img className="w-9 h-9 rounded-full object-cover hidden md:flex" src={user.id ? user.image : 'https://e7.pngegg.com/pngimages/799/987/png-clipart-computer-icons-avatar-icon-design-avatar-heroes-computer-wallpaper.png'} alt="user photo"
                        onClick={() => {
