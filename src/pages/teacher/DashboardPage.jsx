...
import { getDashboardDetails } from '../../services/teacherApi';
            ...
            <div className='admin-page p-3 ' >
                <main className="p-6 sm:p-10 space-y-6">
                    ...
                    <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
                        ...
                        <NumberCard icon={<FaChalkboardTeacher />} data={dashboardDetails?.orderCount} color={"text-green-600 bg-green-100"} title={'Enrolments'} />

                        <NumberCard icon={<GiBookshelf />} data={dashboardDetails?.courseCount} color={"text-blue-600 bg-blue-100"} title={'Courses'} />

                        <NumberCard icon={<CgCommunity />} data={''} color={"text-red-600 bg-red-100"} title={'Blocked Courses'} />
